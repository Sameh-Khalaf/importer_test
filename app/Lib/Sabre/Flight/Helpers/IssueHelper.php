...
//                $participantsCollection->putByIndex('pnr_id', $identCollection->offsetGet('id'), $i);
                ...
                $participants_index = $ticketDataCollection->getByIndex('participants_index',$i);
                $participantArray = $participantsCollection->offsetGetByIndexNumber('*', $participants_index);
                $participantArray['pnr_id'] = $identCollection->offsetGet('id');

                $participantsModel = new Participants($participantArray);
