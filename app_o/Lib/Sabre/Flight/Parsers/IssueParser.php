        ...
        if(isset($fileDataArray['M5'])){
            ...
            foreach ($fileDataArray['M5'] as $key=>$single) {
                ...
                if(in_array($participantsId,$this->validParticipants)) {
                    $priceCollection->putByIndex('fare_amount', Sab_matchNewFareAmount($single), $participantsId);
                    $priceCollection->putByIndex('fare_currency', 'EGP', $participantsId);
                    $priceCollection->putByIndex('tax_amount', Sab_matchNewTaxAmount($single), $participantsId);
