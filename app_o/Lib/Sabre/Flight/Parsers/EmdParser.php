...
//                $identCollection->put('total_pnr_passengers', matchTotalPassengerInPNR($singleLine));
        ...
        if (isset($fileDataArray['M5'])) {
            ...
            if(isset($fileDataArray['MG'])){
                foreach ($fileDataArray['MG'] as $singleLine){
                    $partId = substr($singleLine,2,2);
            ...
            foreach ($fileDataArray['M5'] as $singleLine) {
                ...
                $priceCollection->putByIndex('fare_amount', Sab_matchNewFareAmount($singleLine), $participantsId);
                $priceCollection->putByIndex('fare_currency', 'EGP', $participantsId);
                $priceCollection->putByIndex('tax_amount', Sab_matchNewTaxAmount($singleLine), $participantsId);
                $priceCollection->putByIndex('tax_currency', 'EGP', $participantsId);
                $priceCollection->put('emd_flag', false);
                $totalFare += Sab_matchNewFareAmount($singleLine);
                $totalTax += Sab_matchNewTaxAmount($singleLine);
        ...
        if (isset($fileDataArray['M5'])) {
            foreach ($fileDataArray['M5'] as $key => $singleLine) {
                ...
                if (in_array($participantsId, $this->assignedTicketsParticipants)) {
                    ...
                    $ticketDataCollection->putByIndex('fare_amount', $priceCollection->getByIndex('fare_amount', $participantsId), $counter);
                    $ticketDataCollection->putByIndex('fare_currency', 'EGP', $counter);
                    $ticketDataCollection->putByIndex('tax_amount', $priceCollection->getByIndex('tax_amount', $participantsId), $counter);
                    ...
                    $ticketDataCollection->putByIndex('original_number', '-',  $counter);
                    ...
                    $ticketDataCollection->putByIndex('fare_amount', $priceCollection->getByIndex('fare_amount', $participantsId), $this->ticketCounter);
                    $ticketDataCollection->putByIndex('fare_currency', 'EGP', $this->ticketCounter);
                    $ticketDataCollection->putByIndex('tax_amount', $priceCollection->getByIndex('tax_amount', $participantsId), $this->ticketCounter);
